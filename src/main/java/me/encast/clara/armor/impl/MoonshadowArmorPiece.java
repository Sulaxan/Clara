...
public class MoonshadowArmorPiece implements ClaraArmor {
    ...
    private static double HEALTH = 500; // +175
    private static double DEFENSE = 0.075; // 7.5%

    public static final String HELMET_ID = "moonshadow_helmet";
    public static final String CHESTPLATE_ID = "moonshadow_chestplate";
    public static final String LEGGINGS_ID = "moonshadow_leggings";
    public static final String BOOTS_ID = "moonshadow_boots";

    public MoonshadowArmorPiece(Type type, Material material, String id) {
        this.type = type;
    ...
    public String getName(Locale locale) {
        return "Moonshadow " + StringUtils.capitalize(type.name().toLowerCase());
    }
    ...
    public String[] getLore(Locale locale) {
        return Clara.ITEM_MSG.getMultiline(
                locale.getKey(),
                "item.armor.moonshadow.armor.lore",
                HEALTH,
                DEFENSE * 100
        );
    }
