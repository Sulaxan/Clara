...
public class TimeCrystalArmorPiece implements ClaraArmor {
    ...
    private static double HEALTH = 1500; // +750
    private static double DEFENSE = 0.14; // 10%

    public static final String HELMET_ID = "time_crystal_helmet";
    public static final String CHESTPLATE_ID = "time_crystal_chestplate";
    public static final String LEGGINGS_ID = "time_crystal_leggings";
    public static final String BOOTS_ID = "time_crystal_boots";

    public TimeCrystalArmorPiece(Type type, Material material, String id) {
        this.type = type;
    ...
    public String getName(Locale locale) {
        return "Time Crystal " + StringUtils.capitalize(type.name().toLowerCase());
    }
    ...
    public String[] getLore(Locale locale) {
        return Clara.ITEM_MSG.getMultiline(
                locale.getKey(),
                "item.armor.time_crystal.armor.lore",
                HEALTH,
                DEFENSE * 100
        );
    }
    ...
    public ItemStack getNewItemInstance() {
        return new ItemBuilder(material, ItemBuilder.ItemType.LEATHER_ARMOUR)
                .setColor(Color.fromRGB(40, 181, 181))
                .setUnbreakable(true)
