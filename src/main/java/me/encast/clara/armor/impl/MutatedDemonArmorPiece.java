...
public class MutatedDemonArmorPiece implements ClaraArmor {
    ...
    private static double HEALTH = 1000; // +750
    private static double DEFENSE = 0.11; // 10%

    public static final String HELMET_ID = "mutated_demon_helmet";
    public static final String CHESTPLATE_ID = "mutated_demon_chestplate";
    public static final String LEGGINGS_ID = "mutated_demon_leggings";
    public static final String BOOTS_ID = "mutated_demon_boots";

    public MutatedDemonArmorPiece(Type type, Material material, String id) {
        this.type = type;
    ...
    public String getName(Locale locale) {
        return "Mutated Demon " + StringUtils.capitalize(type.name().toLowerCase());
    }

    @Override
    public ItemRarity getRarity() {
        return ItemRarity.GODLY;
    }
    ...
    public String[] getLore(Locale locale) {
        return Clara.ITEM_MSG.getMultiline(
                locale.getKey(),
                "item.armor.mutated_demon.armor.lore",
                HEALTH,
                DEFENSE * 100
        );
    }
    ...
    public ItemStack getNewItemInstance() {
        return new ItemBuilder(material, ItemBuilder.ItemType.LEATHER_ARMOUR)
                .setColor(Color.fromRGB(41, 138, 51))
                .setUnbreakable(true)
